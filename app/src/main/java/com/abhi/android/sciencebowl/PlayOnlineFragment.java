...
public class PlayOnlineFragment extends QuestionFragment implements RandomQuestion.QuestionInterface, View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        opId = getArguments().getString(UID_KEY);
        opName = getArguments().getString(NAME_KEY);
        gameKey = getArguments().getString(GAME_KEY);
    ...
    private void fetchQuestions(String opponent) {
        ...
        firebaseRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                firebaseRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(FirebaseError firebaseError) {
                        Toast.makeText(getActivity(),"The fetch was cancelled: 1",Toast.LENGTH_SHORT).show();;
                    }
                });
            }
            ...
            @Override
            public void onCancelled(FirebaseError firebaseError) {
                Toast.makeText(getActivity(),"The fetch was cancelled.",Toast.LENGTH_SHORT).show();;
            }
        });
    }
    ...
    private void setQuestions(String opponent, int i) {
        //push new game
        Toast.makeText(getActivity(),"SET QUESTIONS",Toast.LENGTH_SHORT).show();
    ...
    private void updateOpponentAnswer(Choice c){
        ...
        Toast.makeText(getActivity(),"Opponent answered: "+c+ " His/her score: "+ String.valueOf(mScoreOpp),Toast.LENGTH_LONG).show();
    ...
    private void nextQuestion() {
        mOppAnswered = false;
        mSelfAnswered = false;
        Toast.makeText(getActivity(),"Starting next question.",Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(getActivity(),"Starting countdown",Toast.LENGTH_SHORT).show();
        count.start();
    }
    ...
    private void checkExistingGame(String opp) {
        ...
        firebaseRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(FirebaseError firebaseError) {
                Toast.makeText(getActivity(),"The read was cancelled.",Toast.LENGTH_SHORT).show();;
            }
        });
    }

    protected void initializeVariables(View v) {
        ...
        ln = (LinearLayout) v.findViewById(R.id.linGame);
        rl = (RelativeLayout) v.findViewById(R.id.offlineOverlay);

        tvScoreS = (TextView) v.findViewById(R.id.tvScore1);
        tvScoreO = (TextView) v.findViewById(R.id.tvScore2);

        textic = (TextView) v.findViewById(R.id.tvTicker);

        mQuestionButton = (TextView) v.findViewById(R.id.question);
        mChoiceW = (Button) v.findViewById(R.id.choiceW);
        mChoiceX = (Button) v.findViewById(R.id.choiceX);
        mChoiceY = (Button) v.findViewById(R.id.choiceY);
        mChoiceZ = (Button) v.findViewById(R.id.choiceZ);
